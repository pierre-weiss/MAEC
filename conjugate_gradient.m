% function x = conjugated_gradient(b,x_ini,c3,c4,tol)
%
% 1D solver
%
% Compute the solution of linear system with matrix:
%        M1TM1+M2TM2+alpha nablaT nabla + I,
%
% INPUT:
%
% - b : second member
...
% 
% Developer: Valentin Debarnot, July 21 2016

function x = conjugate_gradient(b,x_ini,c3,c4,tol,iter_max)
n=length(x_ini);
x=x_ini(:);
